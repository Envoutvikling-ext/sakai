...
function updateColors(type: string, color: Color | Surface) {
  if (type === 'primary') {
...
function applyTheme(type: string, color: Color | Surface) {
  if (type === 'primary') {
        ...
        <div class="pt-2 flex gap-2 flex-wrap justify-between">
          <button
            ...
            :class="[
              'border-none w-5 h-5 rounded-full p-0 cursor-pointer outline-offset-1',
              {
                'outline-noir': layoutConfig.surface
                  ? layoutConfig.surface === surface.name
                  : isDarkTheme
                    ? surface.name === 'zinc'
                    : surface.name === 'slate',
                'outline-2': layoutConfig.surface
                  ? layoutConfig.surface === surface.name
                  : isDarkTheme
                    ? surface.name === 'zinc'
                    : surface.name === 'slate',
